...
from exchange_agent_exeutor import CurrencyAgentExecutor
...
def main(host, port):
    ...
    try:
        ...
        #     raise MissingAPIKeyError("WATSONX_API_KEY environment variable not set.")
        # if not os.getenv("WATSONX_PROJECT_ID"):
        #     raise MissingAPIKeyError("WATSONX_PROJECT_ID environment variable not set.")
